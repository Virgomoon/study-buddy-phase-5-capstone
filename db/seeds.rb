...
braxton = User.create(first_name: "Braxton", last_name: "Bricks", username: "Brax", email: "Braxton@cool.com" , password_digest: "Braxiz2kool")
sheila = User.create(first_name: "Sheila", last_name: "Bee", username: "She-la" , email: "itzmeshe-la-b@tt.com" , password_digest: "RockWithShe123")
randall = User.create(first_name: "Randall", last_name: "Shire", username: "Randolf" , email: "randall@mail.com" , password_digest: "44RandolfThaBlue44")
jillian = User.create(first_name: "Jillian", last_name: "Jones", username:"Jill" , email: "Jillian@sweet.com", password_digest: "jillpill2sweet")
zephyr = User.create(first_name: "Zephyr", last_name: "Reli", username: "Zeph" , email: "zephyr@random.com" , password_digest: "ih8passwords")
